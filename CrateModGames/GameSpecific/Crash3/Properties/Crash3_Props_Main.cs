...
namespace CrateModLoader.GameSpecific.Crash3
{
    static class Crash3_Props_Main
    {
        ...
        [ExecutesMods(typeof(Crash3_RemoveBarriers))]
        ...
        [ExecutesMods(typeof(Crash3_Metadata))] [ModHidden]
        ...
        [ExecutesMods(typeof(Crash3_Rand_FlyingLevels))] [ModHidden]
        public static ModPropOption Option_RandFlyingLevels = new ModPropOption(Crash3_Text.Rand_FlyingLevels, Crash3_Text.Rand_FlyingLevelsDesc); //unfinished
        [ModHidden]
        public static ModPropOption Option_RandBikeLevels = new ModPropOption("Randomize Bike Levels", "");
        [ExecutesMods(typeof(Crash3_Rand_BossPatterns))] [ModHidden]
        public static ModPropOption Option_RandBosses = new ModPropOption("Randomize Boss Levels", "");
        [ModHidden]
