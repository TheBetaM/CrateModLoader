...
namespace CrateModLoader.GameSpecific.Crash3
{
    ...
    {
        public static ModPropOption Option_RandWarpRoom = new ModPropOption(new Crash3_Rand_WarpRoom()); //{ Hidden = true };
        public static ModPropOption Option_BackwardsLevels = new ModPropOption(new Crash3_Rand_BackwardsLevels(false));
        public static ModPropOption Option_RandBackwardsLevels = new ModPropOption(new Crash3_Rand_BackwardsLevels(true), CrashTri_Text.Rand_BackwardsLevels, CrashTri_Text.Rand_BackwardsLevelsDesc);
        ...
        public static ModPropOption Option_RemoveWarpRoomBarriers = new ModPropOption(new Crash3_RemoveBarriers());
        ...
        public static ModPropOption Option_Metadata = new ModPropOption(new Crash3_Metadata(), 1) { Hidden = true, };
        ...
        public static ModPropOption Option_RandFlyingLevels = new ModPropOption(new Crash3_Rand_FlyingLevels()) { Hidden = true }; //unfinished
        public static ModPropOption Option_RandBikeLevels = new ModPropOption("Randomize Bike Levels", "") { Hidden = true };
        public static ModPropOption Option_RandBosses = new ModPropOption(new Crash3_Rand_BossPatterns()) { Hidden = true };
