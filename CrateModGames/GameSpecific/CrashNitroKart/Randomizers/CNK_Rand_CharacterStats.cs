    ...
    public class CNK_Rand_CharacterStats : ModStruct<CSV>
    {
        ...
        public override void ModPass(CSV file)
        {
            if (file.FullName.ToLower().Contains("common/physics/kp") || file.FullName.ToLower().Contains(@"common\physics\kp"))
            {
                ...
                table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_AKU_DROP] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_AKU_DROP], CNK_Data_DriverStats.c_BoostInfo_eBOOST_AKU_DROP.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_JUMP_LARGE] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_JUMP_LARGE], CNK_Data_DriverStats.c_BoostInfo_eBOOST_JUMP_LARGE.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_JUMP_MEDIUM] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_JUMP_MEDIUM], CNK_Data_DriverStats.c_BoostInfo_eBOOST_JUMP_MEDIUM.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_JUMP_SMALL] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_JUMP_SMALL], CNK_Data_DriverStats.c_BoostInfo_eBOOST_JUMP_SMALL.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_PAD] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_PAD], CNK_Data_DriverStats.c_BoostInfo_eBOOST_PAD.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_SLIDE_1] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_SLIDE_1], CNK_Data_DriverStats.c_BoostInfo_eBOOST_SLIDE_1.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_SLIDE_2] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_SLIDE_2], CNK_Data_DriverStats.c_BoostInfo_eBOOST_SLIDE_2.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_SLIDE_3] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_SLIDE_3], CNK_Data_DriverStats.c_BoostInfo_eBOOST_SLIDE_3.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_START] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_START], CNK_Data_DriverStats.c_BoostInfo_eBOOST_START.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_SUPER_ENGINE] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_SUPER_ENGINE], CNK_Data_DriverStats.c_BoostInfo_eBOOST_SUPER_ENGINE.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_TURBOBOOST] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_TURBOBOOST], CNK_Data_DriverStats.c_BoostInfo_eBOOST_TURBOBOOST.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_TURBOBOOST_JUICED] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_BoostInfo_eBOOST_TURBOBOOST_JUICED], CNK_Data_DriverStats.c_BoostInfo_eBOOST_TURBOBOOST_JUICED.Value, csv_pos);
                ...
                table[(int)KartPhysicsCharacterRows.c_HiTurnFriction] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_HiTurnFriction], CNK_Data_DriverStats.c_HiTurnFriction.Value, csv_pos);
                ...
                table[(int)KartPhysicsCharacterRows.c_NormalFriction] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_NormalFriction], CNK_Data_DriverStats.c_NormalFriction.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_SlideFrictionHigh] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_SlideFrictionHigh], CNK_Data_DriverStats.c_SlideFrictionHigh.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_SlideFrictionLow] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_SlideFrictionLow], CNK_Data_DriverStats.c_SlideFrictionLow.Value, csv_pos);
                table[(int)KartPhysicsCharacterRows.c_SlideFrictionNorm] = CNK_Common.FloatArray2_To_CSV_FullLine(table[(int)KartPhysicsCharacterRows.c_SlideFrictionNorm], CNK_Data_DriverStats.c_SlideFrictionNorm.Value, csv_pos);
