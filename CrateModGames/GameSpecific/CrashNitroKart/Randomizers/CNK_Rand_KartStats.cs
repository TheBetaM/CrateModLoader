...
namespace CrateModLoader.GameSpecific.CrashNitroKart
{
    public class CNK_Rand_KartStats : ModStruct<CSV>
    {
        ...
        public override void ModPass(CSV file)
        {
            ...
            table[(int)KartPhysicsBaseRows.m_AkuDropTS_m_Quadratic] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_AkuDropTS_m_Quadratic], CNK_Data_KartStats.m_AkuDropTS_m_Quadratic.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_AKU_DROP] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_AKU_DROP], CNK_Data_KartStats.m_BoostInfo_eBOOST_AKU_DROP.Value);
            table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_JUMP_LARGE] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_JUMP_LARGE], CNK_Data_KartStats.m_BoostInfo_eBOOST_JUMP_LARGE.Value);
            table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_JUMP_MEDIUM] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_JUMP_MEDIUM], CNK_Data_KartStats.m_BoostInfo_eBOOST_JUMP_MEDIUM.Value);
            table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_JUMP_SMALL] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_JUMP_SMALL], CNK_Data_KartStats.m_BoostInfo_eBOOST_JUMP_SMALL.Value);
            table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_PAD] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_PAD], CNK_Data_KartStats.m_BoostInfo_eBOOST_PAD.Value);
            table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_SLIDE_1] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_SLIDE_1], CNK_Data_KartStats.m_BoostInfo_eBOOST_SLIDE_1.Value);
            table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_SLIDE_2] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_SLIDE_2] , CNK_Data_KartStats.m_BoostInfo_eBOOST_SLIDE_2.Value);
            table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_SLIDE_3] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_SLIDE_3], CNK_Data_KartStats.m_BoostInfo_eBOOST_SLIDE_3.Value);
            table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_START] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_START], CNK_Data_KartStats.m_BoostInfo_eBOOST_START.Value);
            table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_SUPER_ENGINE] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_SUPER_ENGINE], CNK_Data_KartStats.m_BoostInfo_eBOOST_SUPER_ENGINE.Value);
            table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_TURBOBOOST] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_TURBOBOOST], CNK_Data_KartStats.m_BoostInfo_eBOOST_TURBOBOOST.Value);
            table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_TURBOBOOST_JUICED] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_BoostInfo_eBOOST_TURBOBOOST_JUICED], CNK_Data_KartStats.m_BoostInfo_eBOOST_TURBOBOOST_JUICED.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_BoostSlidePushAngle] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_BoostSlidePushAngle], CNK_Data_KartStats.m_BoostSlidePushAngle.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_CollisionSphereOffset] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_CollisionSphereOffset], CNK_Data_KartStats.m_CollisionSphereOffset.Value);
            table[(int)KartPhysicsBaseRows.m_CtfFlagMaxForwardSpeed] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_CtfFlagMaxForwardSpeed], CNK_Data_KartStats.m_CtfFlagMaxForwardSpeed.Value);
            table[(int)KartPhysicsBaseRows.m_CursedMaxForwardSpeed] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_CursedMaxForwardSpeed], CNK_Data_KartStats.m_CursedMaxForwardSpeed.Value);
            table[(int)KartPhysicsBaseRows.m_DonutFriction] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_DonutFriction], CNK_Data_KartStats.m_DonutFriction.Value);
            table[(int)KartPhysicsBaseRows.m_DonutMinMaxSpeed] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_DonutMinMaxSpeed], CNK_Data_KartStats.m_DonutMinMaxSpeed.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_HiTurnLatFriction] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_HiTurnLatFriction], CNK_Data_KartStats.m_HiTurnLatFriction.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_InAirFriction] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_InAirFriction], CNK_Data_KartStats.m_InAirFriction.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_InvincibiliyMaxForwardSpeed] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_InvincibiliyMaxForwardSpeed], CNK_Data_KartStats.m_InvincibiliyMaxForwardSpeed.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_JumpTimeInAirBoost] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_JumpTimeInAirBoost], CNK_Data_KartStats.m_JumpTimeInAirBoost.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_NormalFriction] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_NormalFriction], CNK_Data_KartStats.m_NormalFriction.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_ShockedMaxForwardSpeed] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_ShockedMaxForwardSpeed], CNK_Data_KartStats.m_ShockedMaxForwardSpeed.Value);
            table[(int)KartPhysicsBaseRows.m_SlideBoostQuadratic] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_SlideBoostQuadratic], CNK_Data_KartStats.m_SlideBoostQuadratic.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_SlideEaseOutPercentBetween] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_SlideEaseOutPercentBetween], CNK_Data_KartStats.m_SlideEaseOutPercentBetween.Value);
            table[(int)KartPhysicsBaseRows.m_SlideEaseOutRotVelSpeed] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_SlideEaseOutRotVelSpeed], CNK_Data_KartStats.m_SlideEaseOutRotVelSpeed.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_SlideFrictionHigh] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_SlideFrictionHigh], CNK_Data_KartStats.m_SlideFrictionHigh.Value);
            table[(int)KartPhysicsBaseRows.m_SlideFrictionLow] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_SlideFrictionLow], CNK_Data_KartStats.m_SlideFrictionLow.Value);
            table[(int)KartPhysicsBaseRows.m_SlideFrictionNorm] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_SlideFrictionNorm], CNK_Data_KartStats.m_SlideFrictionNorm.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_SpikeyFruitMaxForwardSpeed] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_SpikeyFruitMaxForwardSpeed], CNK_Data_KartStats.m_SpikeyFruitMaxForwardSpeed.Value);
            table[(int)KartPhysicsBaseRows.m_SpinOutFriction] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_SpinOutFriction], CNK_Data_KartStats.m_SpinOutFriction.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_SquashedMaxForwardSpeed] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_SquashedMaxForwardSpeed], CNK_Data_KartStats.m_SquashedMaxForwardSpeed.Value);
            ...
            table[(int)KartPhysicsBaseRows.m_StartLineTS_m_Quadratic] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_StartLineTS_m_Quadratic], CNK_Data_KartStats.m_StartLineTS_m_Quadratic.Value);
            table[(int)KartPhysicsBaseRows.m_TimeBubbleMaxForwardSpeed] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_TimeBubbleMaxForwardSpeed], CNK_Data_KartStats.m_TimeBubbleMaxForwardSpeed.Value);
            table[(int)KartPhysicsBaseRows.m_TropyClocksMaxForwardSpeed] = CNK_Common.FloatArray_To_CSV_FullLine(table[(int)KartPhysicsBaseRows.m_TropyClocksMaxForwardSpeed], CNK_Data_KartStats.m_TropyClocksMaxForwardSpeed.Value);
