...
namespace CrateModLoader.GameSpecific.CrashTS
{
    ...
    public static class Twins_Data_Textures
    {
        ...
        { AllowedConsoles = new List<ConsoleMode>() { ConsoleMode.PS2 }, Hidden = true, }; // changing it does nothing, game seems to load it from default instead?
        ...
        { AllowedConsoles = new List<ConsoleMode>() { ConsoleMode.PS2 }, AllowedRegions = new List<RegionType>() { RegionType.NTSC_U } };
        public static ModProp_TextureFile Texture_Font_CrashPAL = new ModProp_TextureFile(false, "Font - Crash (PAL)", "")
        { AllowedConsoles = new List<ConsoleMode>() { ConsoleMode.PS2 }, AllowedRegions = new List<RegionType>() { RegionType.PAL } };
        public static ModProp_TextureFile Texture_Font_CrashJPN = new ModProp_TextureFile(false, "Font - Crash (NTSC-J)", "")
        { AllowedConsoles = new List<ConsoleMode>() { ConsoleMode.PS2 }, AllowedRegions = new List<RegionType>() { RegionType.NTSC_J } };
