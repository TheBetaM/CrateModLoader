...
{
    //todo needs testing
    public class TS_SwapStartCreditsSpawn : ModStruct<GenericModStruct>
    {
        ...
        public override void ModPass(GenericModStruct mod)
        {
            ...
            using (FileStream file = new FileStream(ExecFile.Path, FileMode.Open, FileAccess.ReadWrite, FileShare.ReadWrite))
            {
                ...
                {
                    reader.BaseStream.Position = StartLevelPathOff[ExecFile.Index];
                ...
                using (BinaryWriter writer = new BinaryWriter(file))
                {
                    ...
                    writer.BaseStream.Position = StartLevelPathOff2[ExecFile.Index];
