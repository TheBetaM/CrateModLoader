...
{
    public class ModPropNamedFloatArrayGUI : ModPropertyGUI<ModPropNamedFloatArray>
    {

        public ModPropNamedFloatArrayGUI(ModPropNamedFloatArray p) : base(p)
        {
        ...
        public override void UpdateUI()
        {
            ...
            {
                nums[i].Value = (decimal)Prop.Value[i];
            }
