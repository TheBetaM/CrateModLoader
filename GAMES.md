...
Supported: NTSC-U/PAL PS2 versions (.ISO format), All GC versions (.ISO format) (PSP not yet supported)  
...
## Crash of the Titans
Supported: All PS2 versions (.ISO format), All Wii versions (.ISO format) (PSP not yet supported)  
API by NeoKesha.  
### Features:   
